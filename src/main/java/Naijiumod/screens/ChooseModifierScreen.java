...
public class ChooseModifierScreen extends CustomScreen implements ScrollBarListener
{ private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString("GridCardSelectScreen");
    ...
    public void render(SpriteBatch sb) {
        ...
        if (!PeekButton.isPeeking && (
                this.forUpgrade || this.forTransform || this.forPurge || this.isJustForConfirming || this.anyNumber || this.forClarity))
    ...
    {
        @SpireEnum
        public static AbstractDungeon.CurrentScreen CHOOSE_SCREEN;
    }

    @Override
    public AbstractDungeon.CurrentScreen curScreen()
    {
        return Enum.CHOOSE_SCREEN;
    }
