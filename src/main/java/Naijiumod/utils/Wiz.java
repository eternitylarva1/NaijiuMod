...
import Naijiumod.action.TimedVFXAction;
import Naijiumod.power.LosePowerPower;
...
public class Wiz {
  ...
  public static void tfx(AbstractGameEffect gameEffect) {
    atb((AbstractGameAction)new TimedVFXAction(gameEffect));
  }
  ...
  public static void topDeck(AbstractCard c, int i) {
    AbstractDungeon.actionManager.addToBottom((AbstractGameAction)new MakeTempCardInDrawPileAction(c, i, false, true));
  }
  ...
  public static void applyToSelfTemp(AbstractPower po) {
    atb((AbstractGameAction)new ApplyPowerAction((AbstractCreature)AbstractDungeon.player, (AbstractCreature)AbstractDungeon.player, po, po.amount));
    atb((AbstractGameAction)new ApplyPowerAction((AbstractCreature)AbstractDungeon.player, (AbstractCreature)AbstractDungeon.player, (AbstractPower)new LosePowerPower((AbstractCreature)AbstractDungeon.player, po, po.amount)));
  }
  
  public static void applyToSelfNextTurn(AbstractPower po) {
    atb((AbstractGameAction)new ApplyPowerAction((AbstractCreature)AbstractDungeon.player, (AbstractCreature)AbstractDungeon.player, (AbstractPower)new NextTurnPowerPower((AbstractCreature)AbstractDungeon.player, po)));
  }
