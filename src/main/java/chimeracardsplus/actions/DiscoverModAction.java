...
import Naijiumod.patchs.RolledModFieldPatches;
...
public class DiscoverModAction extends AbstractGameAction {
    ...
    private ArrayList<AbstractCard> generateCardChoices() {
        ArrayList<AbstractAugment> filter = ItemMod.getModifiers().stream().filter((mod) -> !(mod instanceof HealingMod)).collect(Collectors.toCollection(ArrayList::new));
